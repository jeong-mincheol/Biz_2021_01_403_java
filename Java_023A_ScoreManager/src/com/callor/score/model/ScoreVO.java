...
public class ScoreVO {
	 ...
	 * ScoreVO score = new ScoreVO(학번, 국어점수, 영어점수, 수학점수, 음악점수, 국사점수)
	 * 이때 호출되는 method
	 */
	...
	/*
	 * private으로 선언되 인스턴스변수에 접근할 getter와 setter method 생성
	 */
	...
	/*
	 * Object 클래스로부터 상속받은 toString() method를 재정의
	 * 
	 * VO 객체에 데이터를 저장한 후 잘 저장되어 있는지 확인하기 위한 Debuging 용 
	 * method 재정의
	 */
	@Override
