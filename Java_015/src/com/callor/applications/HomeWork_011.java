...
public class HomeWork_011 {
	...
	/*
	 * 2이상의 임의의 정수 100을 만들고 PrimeServiceV2의 prime() method를 호출하여 임의의 정수 100개중 소수인
	 * 수들의 리스트를 출력 소수인 수들의 합
	 */
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 100; i++) {
			/*
			 * 0~9999까지의 난수를 생성하고 생성된 난수에 +2를 수행하라 실제 생성된 수는 2 ~ 10001까지 중에 난수를 생성하여 rndNum에
			 * 저장
			 */
			int rndNum = rnd.nextInt(10000) + 2;

			/*
			 * psV2 클래스의 prime() method는 rndNUm가 소수이면 그 수를 그대로 return 아니면 -1을 return
			 */
