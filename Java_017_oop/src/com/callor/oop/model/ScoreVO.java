 ...
 * 		setter, getter method들 통해서 접근해야 한다
 ...
 *  setIntKor() method는 intKor 인스턴스 변수에서 값을
 *  읽기 기능을 한다는 것을 알 수 있다.
 *  
 *  코드 내용이 어떠한지 몰라도
 *  getter 와 setter를 통하여 변수에 접근(저장,읽기) 할 수 있다.
 * 
 */
