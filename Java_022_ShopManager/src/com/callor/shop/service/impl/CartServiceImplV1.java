...
public class CartServiceImplV1 implements CartService{
	...
	public void inputCart() {
		...
		System.out.print(">> ");
		String strProductNmae = scan.nextLine();
		...
		cartVO.setProductName(strProductNmae);
